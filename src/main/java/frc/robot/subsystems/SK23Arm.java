...
public class SK23Arm
{
    ...
    public SK23Arm()
    {
        angleMotor = new ArmAngleInternal(kMotorType, ArmPorts.kMainMotor,
            kRotationRatio, ArmPorts.kResetSwitch,
            ArmPorts.kLimitSwitch, kArmMotorP, kArmMotorI,
            kArmMotorD);
    }
    ...
    {
        switch (angle){
            case HighCube : angleMotor.setAngle(kHighCube);
            break;
            case MidCube : angleMotor.setAngle(kMidCube);
            break;
            case LowCube : 
            ...
            break;
            case LowCone : angleMotor.setAngle(kLowCone);
            break;

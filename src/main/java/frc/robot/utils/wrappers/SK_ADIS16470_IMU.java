...
/**
 * An ADIS16470IMU that can be used to measure rotations, acceleration,
 * temprature, etc.
 */
public class SK_ADIS16470_IMU extends ADIS16470_IMU {
     ...
     */
    public SK_ADIS16470_IMU(final IMUAxis yaw_axis, SPI.Port port, CalibrationTime cal_time) {

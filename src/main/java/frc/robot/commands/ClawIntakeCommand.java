...
public class ClawIntakeCommand extends CommandBase
{
     ...
     */
    public ClawIntakeCommand(SK23ClawIntake intake)
    {
        this.intake = intake;
    ...
    {
        intake.setLeftSpeed(Constants.ClawIntakeConstants.CLOCKWISE_LEFTMOTOR_SPEED);
        intake.setRightSpeed(Constants.ClawIntakeConstants.CLOCKWISE_RIGHTMOTOR_SPEED);
    }
